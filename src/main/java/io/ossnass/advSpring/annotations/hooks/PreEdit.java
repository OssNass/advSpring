...
/**
 * When a function is annotated with this annotation inside {@link CRUDService} class, the function will be called before calling the edit function in said service
 * <p>
 ...
 * <p>
 * The function of preEdit must accept 1 parameter for input of the same class the entity, the return value must be of some other type Object
 * <code>
 * Object preEdit(Entity e){
 * return o;
 * }
 * </code>
 * <p>
 ...
 * as a result it will be passed to functions annotated {@link PostEdit} with the same order as the current preAdd hook
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface PreEdit {
    /**
